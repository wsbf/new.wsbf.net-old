...
$newPath = BASE_NEW_CART . $filename;
...
$query = "INSERT INTO libcart (start_date, end_date, title, issuer, cart_typeID, filename) VALUES('$startDate', '$endDate', '$cartName', '$cartIssuer', '$cartType', '$filename')";
$insert = mysql_query($query) or die(mysql_error());

$q = "SELECT * FROM libcart WHERE title = '$cartName'";
