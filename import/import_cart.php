...
echo "<b>Cart Path:</b> ". $cartPath ." <br /><br />";
...
echo "<tr><td>Type</td><td><input type='radio' name='cartType' value='0' />PSA<br /><input type='radio' name='cartType' value='1' />Underwriting<br /><input type='radio' name='cartType' value='3' />Promotion<br /><input type='radio' name='cartType' value='2' />Station<br /><input type='radio' name='cartType' value='5' />Other<br /></td></tr>";
