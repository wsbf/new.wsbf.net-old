...
<td>Date:</td>
<td>
	<input type="text" class="required ui-state-default ui-corner-all" id="datepicker" name="date"/>
...
<tr>
	<td>Start Time:</td>
	<td>
		<select class="timeRange required ui-state-default ui-corner-all" id="timeFrom" name="start_time">
...
<tr>
	<td>End Time:</td>
	<td>
		<select class="timeRange required ui-state-default ui-corner-all" id="timeTo" name="end_time">
			<option value="01:00:00">1:00 AM</option>
			<option value="03:00:00">3:00 AM</option>
			<option value="05:00:00">5:00 AM</option>
			<option value="07:00:00">7:00 AM</option>
