...
//	$review = mysql_real_escape_string($row['review']);
	...
	$sql="INSERT INTO fishbowl_log (timestamp, username, semesters, missedShows, liveShows, springFest, specialty, dead_hours, other, weight)
	VALUES
	('$timestamp', '$username','$semesters', '$missedShows', '$liveShows', '$springFest', '$specialty', '$dead_hours', '$other', '$weight')";
