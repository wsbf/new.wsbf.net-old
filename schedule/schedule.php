...
function openDialog(show_name, dj_name, show_desc) {
	...
	$('#dialog').html("<p style='text-align:center'><img src='http://wsbf.net/misc/ajax-loader-bar.gif' alt='loading' /></p>");
	...
	$("#tabs-jqui").tabs({
		ajaxOptions: {
			error: function(xhr, status, index, anchor) {
				...
				$('#tabs-jqui').append("<p>Error: Couldn't load this tab!<br><pre>"+status+" "+xhr+" "+index+" "+anchor+"</pre></p>");
			}
		}
	});
...
*/
	foreach($tabs as $tab => $name)
		echo "<li><a href='/wizbif/schedule/schedule_load_tab.php?tab=$tab'>$name</a></li>\n";
	?>
	</ul>
</div>
</body>
